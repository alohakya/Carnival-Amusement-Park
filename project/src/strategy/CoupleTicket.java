...
public class CoupleTicket implements TicketStrategy{
    /**
     *买票函数，实现了买票的功能
     */
    @Override
    public void buyTicket(){
        ...
        System.out.println("======================================");
        System.out.println("您选择了购买情侣票，成人票票价：360rmb");
        Ticket ticket=new Ticket();
        ticket.setType(Const.COUPLE_TICKET);
        ticket.setPrice(Const.COUPLE_TICKET_MONEY);
        ticket.buy();
